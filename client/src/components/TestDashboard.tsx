  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden md:block">
                <div className="text-sm text-gray-600">
                  {getGreeting()}, {user?.user_metadata?.firstName || user?.email?.split('@')[0] || 'there'}
                </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Hero Section */}
        <div className="mb-8">
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white border-0 relative overflow-hidden rounded-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              },
              {
                ...
                description: 'Track meals & nutrition',
                href: '/nutrition'
              },
              {
                id: 'vitals',
              ...
              return (
                <Link key={action.id} href={action.href}>
                  <div className="group cursor-pointer hover:shadow-xl transition-all duration-300 border border-gray-100 bg-white rounded-xl p-6 relative">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={metric.label} className="border border-gray-100 bg-white rounded-xl p-6">
            ...
            {[
              ...
              return (
                <Link key={insight.id} href={insight.href}>
                  <div className="hover:shadow-md transition-shadow cursor-pointer border border-gray-100 bg-white rounded-xl p-6">
